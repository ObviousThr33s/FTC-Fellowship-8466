...
@Autonomous(name = "Blue 1: Next to relic recovery", group = "Auto")
public class AutoBlue1 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
            ...
            while (opModeIsActive()) {
                ...
                AutoUtilities.ExecuteMovesBlue(ds, movePower, spinPower, Color.BLUE, true, telemetry, opModeIsActive());
