...
@TeleOp(name = "Samwise Teleop Wait", group = "Samwise")
//@Disabled

public class SamwiseTeleopWait extends SamwiseTeleOp3
{
    ...
    public void loop()
    {
        ...
        {
            runTime.reset();
            armStuff.toCollectionPlane(true, false);
        ...
        {
            runTime.reset();
            armStuff.toLanderSilver(true, false);
            telemetry.addData("Time ", runTime.time(TimeUnit.SECONDS));
        }
        ...
        {
            runTime.reset();
            armStuff.toLanderGold(true, false);
            telemetry.addData("Time ", runTime.time(TimeUnit.SECONDS));
        }
