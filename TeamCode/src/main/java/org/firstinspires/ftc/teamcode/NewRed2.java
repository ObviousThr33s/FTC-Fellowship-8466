...
@Autonomous(name = "NewRed2: opposite to relic recovery", group = "Auto")
public class NewRed2 extends LinearOpMode {
...
//        }
        ...
        utility.ExecuteMovesRed(ds, ele, movePower, spinPower, false, telemetry, cryptoPosition);
